      ...
      <html lang="en">
        ...
        <body style="margin:0px;padding: 0px;">
          <div style="
            ...
            text-align: center;">
            <b>Confirmación de Correo Electrónico</b>
          </div>
          <div 
            style="width: 100%;
            padding: 15px;
            font-family: Arial, Helvetica, sans-serif;"
          >
          <p style="text-align: center !important;">Hola!, bienvenido ${name}, puedes confirmar tu cuenta dando click en el siguiente botón</p>
